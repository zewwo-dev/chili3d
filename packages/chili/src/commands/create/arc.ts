...
import { ArcNode } from "../../bodies/arc";
...
export class Arc extends CreateCommand {
    ...
    protected override geometryNode(): GeometryNode {
        const [p0, p1] = [this.stepData[0].point!, this.stepData[1].point!];
        const plane = this.stepData[1].plane ?? this.findPlane(this.stepData[1].view, p0, p1);
        this._planeAngle?.movePoint(this.stepData[2].point!);
